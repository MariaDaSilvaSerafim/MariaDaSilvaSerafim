...
def main(page: Page):
    ...
    button2 = FilledButton(text = "Voltar", style = ButtonStyle(bgcolor = "#000000", color = "#ffffff"), on_click = lambda e: voltar(e))
    ...
    button1 = FilledButton(text = "Entrar", style = ButtonStyle(bgcolor = "#000000", color = "#ffffff"), on_click = lambda e: entrar(e))
    
    #Imagem de cadastro
    img2 = Image(
        src = "sistema escolar\infor.png",
        width = 100,
        height = 100,
        fit = ImageFit.CONTAIN,
    )
